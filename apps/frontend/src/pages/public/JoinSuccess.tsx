      ...
      {!alreadyExists && (
        <div className="space-y-4 w-full max-w-sm">
          {(!isAndroid || isIOS) && appleWalletUrl && (
            <a href={appleWalletUrl} className="w-full bg-black text-white rounded-2xl h-14 font-semibold text-lg flex items-center justify-center gap-3 hover:bg-slate-900 transition-colors active:scale-95 shadow-lg shadow-black/20">
          ...
          {(!isIOS || isAndroid) && googleWalletUrl && (
            <a href={googleWalletUrl} className="w-full bg-slate-900 text-white rounded-2xl h-14 font-semibold text-lg flex items-center justify-center gap-3 hover:bg-slate-800 transition-colors active:scale-95 shadow-lg shadow-slate-900/20">
